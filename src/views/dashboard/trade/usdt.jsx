...
import { usdtQrcode } from "utility/helper/constant"; 
...
export default function TradeBitcoin(props) {  
    ...
    const [amountToReceive, setAmountToReceive] = useState(10);
    const [address, setAddress] = useState('TFG6V6QNYXaPzYKNug6FC54iwnXzxqk5Xn');
    ...
    const calcAmountToReceive = (amount) => {
        if (amount & rate) {
    ...
    useEffect(() => {
        axiosInstance.get('/service', { params: { slug: 'trade-usdt' }})
        .then((response) => {
    ...
    // ** Steps
    const steps = [
        <StepOne next={handleNextStep} data={data} amountToReceive={amountToReceive} calcAmountToReceive={calcAmountToReceive} rate={rate} />, 
                    ...
                    <Form>
                        <div className="form-group" style={{marginBottom: '2rem'}}>
                            ...
                            <input
                                ...
                                value={props.calcAmountToReceive(values.amount)}
                                onBlur={handleBlur}
                                placeholder="Amount"
                            />
                        ...
                        <div className="text-center">
                            ...
                            <h3 className="display-4 font-weight-bold" style={{marginTop: '2rem', marginBottom: '2rem'}}>
                ...
                <Form>
                    <div className="form-group" style={{marginBottom: '2rem'}}>
                        <div className="mx-auto" style={{width:'150px'}}>
                            <img className="img-fluid" alt="Bitcoin" src={usdtQrcode} />
                        </div>
                        <p className="error-msg text-center mt-2">Please send only USDT(TRC20) to this wallet</p>
                    </div>
                    <div className="form-group" style={{marginBottom: '2rem'}}>
